    ...
    return (
        <div className={styles.DashboardLayout}>
            ...
            <div className={styles.header}>
                <DashboardHeader onSubmitLoadDataPopup={loadGraphData}
            ...
            <div className={styles.visualizations}>
                <Grid container className={styles.top}>
                    ...
                    <Grid item xs={2}>
                        <DetailTab removeNodeData={removeNodeData} expandNodeData={expandNodeData}
                                   selectedElements={selectedElements}/>
                    </Grid>
                </Grid>
                <div className={styles.bottom}>
                    <DataTable graphData={graphData} selectedElements={selectedElements}
